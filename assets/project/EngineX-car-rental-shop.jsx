        ...
        <div className="container mt-2">
            <div className="card">
                <div className="card-header bg-dark text-white">
                    <h2>{t('project_headers.project_name')}</h2>
                </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <strong>C# and
                                            .NET:</strong> {t('enginex_car_rental.technologies_tools.why_these_tools.C# and .NET')}
                                    </li>
                                    <li>
                                        <strong>React:</strong> {t('enginex_car_rental.technologies_tools.why_these_tools.React')}
                                    </li>
                                </ul>
                            </li>
                        </ul>
